...
from shtoryparser.items import ShtoryparserItem


class LeroymerlinSpider(scrapy.Spider):
    name = 'leroymerlin'
    allowed_domains = ['leroymerlin.ru']
    start_urls = ['https://leroymerlin.ru/catalogue/rimskie-shtory']
    ...
    def product_parse(self, response: HtmlResponse):
        loader = ItemLoader(item=ShtoryparserItem(), response=response)
